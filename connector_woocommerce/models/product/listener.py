...
class WooProductProductBindingExportListener(Component):
    _name = 'woo.product.product.binding.export.listener'
...
class WooProductProductExportListener(Component):
    _name = 'woo.product.product.export.listener'
    _inherit = 'base.connector.listener'
    _apply_on = ['woo.product.product']
