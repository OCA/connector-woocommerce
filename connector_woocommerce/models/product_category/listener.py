...
class WooProductCategoryBindingExportListener(Component):
    _name = 'woo.product.category.binding.export.listener'
...
class WooProductCategoryExportListener(Component):
    _name = 'woo.product.category.export.listener'
    _inherit = 'base.connector.listener'
    _apply_on = ['woo.product.category']
